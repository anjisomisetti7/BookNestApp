...
const SignUp = ({ onBack, onSignUpSuccess }: SignUpProps) => {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: `Hello ${formData.name}! Your account has been created successfully. Welcome to our community of book lovers!`,
    });

    // Call success callback with user email
    onSignUpSuccess(formData.email);

    // Go back to main page after successful sign-up
    setTimeout(() => {
      onBack();
    }, 2000);
  };
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-64px)] py-12 px-4">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Join BookNest!</h2>
